  ...
  return (
    <div className="bg-primary text-white py-8 md:py-16">
      <div className="max-w-3xl mx-auto text-center px-4 md:px-0">
        ...
        <p className="font-svn-snell text-2xl md:text-4xl my-6 md:my-12">
          Together with our families,
          <br />
          We request the honor of your presence at the celebration of our
          marriage
        </p>
        ...
        <p className="font-eb-garamond text-xs md:text-sm mt-2">
          91 TRAN HUNG DAO, HOAN KIEM, HA NOI
        </p>
      </div>
    </div>
  );
